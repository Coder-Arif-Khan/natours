...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWRhcmlmLWtoYW4iLCJhIjoiY2wyZGc4b2cwMDFhMTNjcDl5Z25ucGsxbiJ9.TupgNSv3_74BPIcF1nEawA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mdarif-khan/cl2dhg3g700bc15jzw81h2139',
    scrollZoom: false // center: [-118.172696, 34.064159],
    // zoom: 10,
    // interactive: false,
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You are logged in successfully!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You are logged out successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000); // location.reload(true);
            }
...
var stripe = Stripe('pk_test_51L05aBSFSSEEOcmgbfd2HjkslvA06gAP7bP5Da0rM2Rim1Q1JStCmcZ6MTeYK00aZId0aXi6sZoqNpfMo6z2QF3j00fve6spWN');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.table(session); // 2> Create checkout form + Charge credit card
          ...
          case 9:
            ...
            (0, _alerts.showAlert)('success', _context.t0);
